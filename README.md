About trame-vtklocal-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/trame-vtklocal-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/trame-vtklocal-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add trame-vtklocal
# for installing globally
pixi global install trame-vtklocal
```
...
It is possible to list all of the versions of `trame-vtklocal` available on your platform:
...
```
pixi search trame-vtklocal --channel conda-forge
```
